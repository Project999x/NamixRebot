...
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7208244255:AAHtPsGavcQjTX_-KCGm8Sfyv4X4GTMGgx0")
...
DB_NAME = os.environ.get("DATABASE_NAME", "NamiXRobit_Bot")

TG_BOT_WORKERS = int(os.environ.get("TG_BOT_WORKERS", "4"))

#Collection of pics for Bot // #Optional but atleast one pic link should be replaced if you don't want predefined links
PICS = (os.environ.get("PICS", "https://files.catbox.moe/43gslj.jpg")).split() #Required
